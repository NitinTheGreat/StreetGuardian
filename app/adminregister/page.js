...
export default function EnhancedAdminRegister() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-[#01579b] via-[#0277bd] to-[#e0f2f1] relative overflow-hidden">
      <BackgroundShapes />
      <motion.div
        className="w-full max-w-md p-8 bg-white mt-14 bg-opacity-90 rounded-2xl shadow-2xl relative z-10 h-1/2"
        initial="hidden"
        animate="visible"
