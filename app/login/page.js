...
export default function Login() {
  ...
  return (
    ...
    >
      <div className="max-w-6xl w-full flex rounded-3xl overflow-hidden shadow-2xl">
        <motion.div 
        ...
        >
          ...
          <motion.form onSubmit={handleSubmit} variants={childVariants}>
            <motion.div className="mb-4" variants={inputVariants} whileFocus="focus" whileBlur="blur">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="w-full px-10 py-2 border border-gray-300 rounded-full focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent shadow-sm transition-all duration-200 hover:shadow-md focus:shadow-blue-500/25"
                />
              </div>
            </motion.div>
            <motion.div className="mb-4" variants={inputVariants} whileFocus="focus" whileBlur="blur">
            ...
            <motion.button
              ...
              whileHover="hover"
              whileTap="tap"
              className="w-full py-2 px-4 border border-transparent rounded-full shadow-sm text-sm font-medium text-white bg-gradient-to-r from-teal-600 to-blue-600 hover:from-teal-700 hover:to-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-all duration-200 hover:shadow-lg hover:shadow-blue-500/50 relative overflow-hidden group"
            >
